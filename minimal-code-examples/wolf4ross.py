...
def Composify(f, a, *b): return lambda *x: f(a, Composify(f, First(b), *Rest(b))(*x)) if Length(b) > 1 else f(a,First(b)(*x)) 
...
@infix.div_infix
def c0r(a,*b): return Composify(m0r, a, *b)  #lambda *x: m0(a,b(*x)) #CurrySwap(Curry(m0)(a) /c/ b)()

@infix.div_infix
def c1r(a,*b): return Composify(m1r, a, *b) #lambda *x: m1(a,b(*x)) 

@infix.div_infix
def cinfr(a,*b): return Composify(minfr, a, *b) #lambda *x: minf(a,b(*x))
...
def _runtests():
	...
	Composify(a, math.tan,math.cos, math.sin)(0) /ar/ printme(npp())
	c(Curry(lambda x,y: x/y)(1), math.sin, math.cos)(1)() /ar/ printme(npp())
	c(partial(myf,1), math.sin, math.cos)(1) /ar/ printme(npp())
