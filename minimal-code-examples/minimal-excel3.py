...
summaries = lambda d: GetLabeledEngineSummaryAllYears(mynYears, [myAsset, d[0]])(d[1]) /m/ Enumerate(myData /mlog/ (myPaths /m/ Range(mynScens)))
(lambda m: WriteMatrixToNewXLSSheet('C:\\Users\\SEC\\Documents\\CSEIP\\Resultate\\Hydropt\\Emo3\\pythonExportTest2.xls', Transpose(m))) /m/ (Last /m/ summaries)
(lambda m: WriteMatrixToCSV('C:\\Users\\SEC\\Documents\\CSEIP\\Resultate\\Hydropt\\Emo3\\pythonExportTestScen' + str(m[0]+1) + '.csv', Transpose(m[1]))) /m/ summaries
